package com.example.zhujiang.myapplication.pageRecycler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setAdapter(myAdapter = mRecyclerView.new PageAdapter(dataList, new PageRecyclerView.CallBack() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(PageActivity.this).inflate(R.layout.item, parent, false);
            ...
            public void onItemClickListener(View view, int position) {
                Toast.makeText(PageActivity.this, "点击："
                        + dataList.get(position), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onItemLongClickListener(View view, int position) {
                Toast.makeText(PageActivity.this, "删除："
                        + dataList.get(position), Toast.LENGTH_SHORT).show();

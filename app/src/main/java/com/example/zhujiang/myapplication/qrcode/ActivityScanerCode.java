package com.example.zhujiang.myapplication.qrcode;
...
import com.example.zhujiang.myapplication.qrcode.decoding.InactivityTimer;
...
public class ActivityScanerCode extends Activity {
  ...
  @Override protected void onStart() {
    super.onStart();
    mQrLineView.startAnimation(getTrans());
  }
   ...
   * 扫描动画
   */
  private TranslateAnimation getTrans() {
    if (animation == null) {

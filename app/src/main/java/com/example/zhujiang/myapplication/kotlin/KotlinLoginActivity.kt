package com.example.zhujiang.myapplication.kotlin
 ...
 */
class KotlinLoginActivity : AppCompatActivity(), LoaderCallbacks<Cursor> {
  /**
  ...
  override fun onCreateLoader(i: Int, bundle: Bundle?): Loader<Cursor> {
    return CursorLoader(this,
        ...
        arrayOf(ContactsContract.CommonDataKinds.Email
            .CONTENT_ITEM_TYPE),
  ...
  private fun addEmailsToAutoComplete(emailAddressCollection: List<String>) {
    ...
    val adapter = ArrayAdapter(this@KotlinLoginActivity,
